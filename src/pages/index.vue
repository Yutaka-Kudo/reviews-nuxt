<template>
    <v-container class="index_wrap">
        <div class="description d-flex flex-wrap justify-center">
            ...
            <p>
                レストラン、居酒屋、飲食店の口コミ・レビューを各グルメサイトからまとめて最新順でCheck！お近くの居酒屋はもちろん、デリバリー専門店も検索可能。気になってるお店の最新口コミをさくっとGET！
            </p>
        </div>
        ...
        <p class="registed_num mb-5">各グルメサイト(Google my business、食べログ、ぐるなび、HotPepper、UberEats 等)の口コミ、レビューの点数を参考にランク付けをしています。<br>それぞれのグルメサイトの特性を加味した上でのランク付けに努めています。<br>(例：食べログは他グルメサイトと比べ、相対的に高得点がつきにくいため、このサイト内でのランキングのための点数を補正しています)<br>あくまでも製作者の勝手なランキングです。</p>
    </v-container>
</template>
